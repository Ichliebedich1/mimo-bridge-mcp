...
- Reasonix reliability: routing effort maps to higher `--max-steps` caps (low=20, medium=40, high=80), and the runner auto-resumes saved sessions up to 4 times when Reasonix pauses at `agent.max_steps`.
