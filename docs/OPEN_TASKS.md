...
5. Continue P6 with the design in `docs/modules/multi-agent-dispatch.md` and `docs/modules/reasonix-tui-adapter.md`: next slice is richer Reasonix live/session parsing, then MiMo adapter migration to generic tools and GUI shared-session viewing.
