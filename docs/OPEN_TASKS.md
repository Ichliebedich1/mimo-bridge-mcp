...
5. Continue P6 with the design in `docs/modules/multi-agent-dispatch.md` and `docs/modules/reasonix-tui-adapter.md`: next slices are MiMo adapter migration to generic tools, GUI shared-session viewing/opening, and Reasonix token/cost extraction if stable fields exist.
