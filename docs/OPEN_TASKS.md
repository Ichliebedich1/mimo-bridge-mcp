...
5. Continue P6 with the design in `docs/modules/multi-agent-dispatch.md` and `docs/modules/reasonix-tui-adapter.md`: next slices are MiMo adapter migration to generic tools, direct Reasonix GUI shared-session opening if stable support exists, and final package rebuild/release validation.
