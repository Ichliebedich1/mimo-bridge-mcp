...
- Latest package build after P6.16 succeeded with `npm.cmd run package:installer`. Artifacts: `artifacts\MiMoBridgeSetup-win10-win11-x64.exe` (55,603,200 bytes) and ignored local `artifacts\MiMoBridge-portable-win10-win11-x64.zip` (55,640,193 bytes). `npm.cmd run validate:release -- -SkipPackageBuild` passed and wrote ignored local `artifacts\release-validation.json`; installer self-test exit was 0.
