...
describe("token-budget", () => {
  ...
  it("should aggregate usage by agent and time range", () => {
    ...
    assert.strictEqual(analytics.by_model["mimo-v2.5"].input_tokens, 1000);
    ...
    assert.strictEqual(analytics.time_ranges_by_model.all["mimo-v2.5"].cache_read_tokens, 100);
